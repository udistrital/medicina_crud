...
func init() {
	...
	beego.GlobalControllerRouter["Medicina/controllers:TipoSistemaController"] = append(beego.GlobalControllerRouter["Medicina/controllers:TipoSistemaController"],
		beego.ControllerComments{
			Method:           "Post",
			Router:           "/",
			AllowHTTPMethods: []string{"post"},
