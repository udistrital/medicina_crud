...
type MedicinaHojaHistoriaController struct {
	beego.Controller
}

//URLMapping ...
func (c *MedicinaHojaHistoriaController) URLMapping() {
...
// @Param	body		body 	models.MedicinaHojaHistoria	true		"Cuerpo para el contenido de MedicinaConsultaFisioterapia"
// @Success 201 {int} models.MedicinaHojaHistoria
// @Failure 403 Cuerpo Vacío
// @router / [post]
func (c *MedicinaHojaHistoriaController) Post() {
	var v models.MedicinaHojaHistoria
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddMedicinaHojaHistoria(&v); err == nil {
...
// @Success 200 {object} models.MedicinaHojaHistoria
// @Failure 403 :id está vacío
// @router /:id [get]
func (c *MedicinaHojaHistoriaController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetMedicinaHojaHistoriaById(id)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		c.Data["json"] = v
...
// @Failure 403
// @router / [get]
func (c *MedicinaHojaHistoriaController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, err := models.GetAllMedicinaHojaHistoria(query, fields, sortby, order, offset, limit)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		c.Data["json"] = l
...
// @router /:id [put]
func (c *MedicinaHojaHistoriaController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.MedicinaHojaHistoria{IdHojaHistoria: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateMedicinaHojaHistoria(&v); err == nil {
			c.Data["json"] = "OK"
		} else {
			c.Data["json"] = err.Error()
		}
...
// @router /:id [delete]
func (c *MedicinaHojaHistoriaController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteMedicinaHojaHistoria(id); err == nil {
		c.Data["json"] = "OK"
	} else {
		c.Data["json"] = err.Error()
	}
