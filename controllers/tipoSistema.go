...
type TipoSistemaController struct {
	beego.Controller
}

// URLMapping ...
func (c *TipoSistemaController) URLMapping() {
...
// @Param	body		body 	models.TipoSistema	true		"Cuerpo para el contenido de TipoSistema"
// @Success 201 {int} models.TipoSistema
// @Failure 403 Cuerpo Vacío
// @router / [post]
func (c *TipoSistemaController) Post() {
	var v models.TipoSistema
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddTipoSistema(&v); err == nil {
...
// @Success 200 {object} models.TipoSistema
// @Failure 403 :id está vacío
// @router /:id [get]
func (c *TipoSistemaController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetTipoSistemaById(id)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		c.Data["json"] = v
...
// @Failure 403
// @router / [get]
func (c *TipoSistemaController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, err := models.GetAllTipoSistema(query, fields, sortby, order, offset, limit)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		c.Data["json"] = l
...
// @router /:id [put]
func (c *TipoSistemaController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.TipoSistema{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateTipoSistema(&v); err == nil {
			c.Data["json"] = "OK"
		} else {
			c.Data["json"] = err.Error()
		}
...
// @router /:id [delete]
func (c *TipoSistemaController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteTipoSistema(id); err == nil {
		c.Data["json"] = "OK"
	} else {
		c.Data["json"] = err.Error()
	}
