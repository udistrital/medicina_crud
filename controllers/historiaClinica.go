...
// @Param	body		body 	models.HistoriaClinica	true		"Cuerpo para el contenido de ConsultaFisioterapia"
// @Success 201 {int} models.HistoriaClinica
// @Failure 403 Cuerpo Vacío
// @router / [post]
func (c *HistoriaClinicaController) Post() {
	var v models.HistoriaClinica
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddHistoriaClinica(&v); err == nil {
...
// @Success 200 {object} models.HistoriaClinica
// @Failure 403 :id está vacío
// @router /:id [get]
func (c *HistoriaClinicaController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetHistoriaClinicaById(id)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		c.Data["json"] = v
...
func (c *HistoriaClinicaController) GetAll() {
	...
	l, err := models.GetAllHistoriaClinica(query, fields, sortby, order, offset, limit)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		c.Data["json"] = l
...
func (c *HistoriaClinicaController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteHistoriaClinica(id); err == nil {
		c.Data["json"] = "OK"
	} else {
		c.Data["json"] = err.Error()
	}
